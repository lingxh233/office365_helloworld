...
function advanced_google_recaptcha_content_key_section() {
	...
	printf( esc_html__( 'Please %1$sregister your domain%2$s first, get required keys from Google (reCAPTCHA v2 or reCAPTCHA v3) and save them below.', 'advanced-google-recaptcha' ), '<a href="https://www.recaptcha.net/recaptcha/admin" target="_blank">', '</a>' );
}
